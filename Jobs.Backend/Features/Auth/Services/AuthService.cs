...
namespace Jobs.Backend.Features.Auth.Services;
...
public class AuthService
{
    ...
    public async Task<SignInResponse> LoginAsync(LoginRequest request)
    {
    ...
    public async Task<SignInResponse> SignInWithGithubAsync(string githubEmail, string githubUsername)
    {
